...
from rail_training import Network, Network_CE, Network_mask1, Network_mask2, test_accuracy
import torch
import sys
import datetime
...
with torch.no_grad():
    ...
    while time.time() < start_loop + timeout :
        ...
        while (Env_learning_nlp.terminated or Env_learning_nlp.truncated)==False and (Env_learning_lp.terminated or Env_learning_lp.truncated)==False and j < 30:
            ...
            for i in range(len(model_list)):
                ...
                if mdl_feasible(mdl_learning_nlp)==True:
                    break
            ...
            if (Env_learning_nlp.terminated or Env_learning_nlp.truncated)==True or (Env_learning_lp.terminated or Env_learning_lp.truncated)==True or j >= 30:
                flag_end_episode = True  
